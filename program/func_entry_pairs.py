    ...
    if len(series_1) > 0 and len(series_1) == len(series_2):
      ...
      if abs(z_score) >= ZSCORE_THRESH:
        ...
        if not is_base_open and not is_quote_open:
          ...
          # Ensure size
          base_min_order_size = markets["markets"][base_market]["minOrderSize"]   #### importante para tener ganancia
          quote_min_order_size = markets["markets"][quote_market]["minOrderSize"] ##### importante para tener ganancia
